...
def shattered_version():
    ...
    """
    version = 201402192
    print("Shattered Acquisition version: ", version)
...
def prep_dir(outdir, sno):
    """
        This function creates the necessary directories for information to be placed within the case directory.
...
def zip_it_up(outdir):
    """Zip yup the findings into a container to prevent further modification
...
if __name__ == "__main__":
    ...
    shattered_version()
    print("      Google Glass Forensic Tool\n\nBrought to you by:\nThe Leahy Center for Digital Investigation at Champlain"
          "College\nLearn more at http://lcdi.champlain.edu\n\nSpecial Thanks to Julie Desautels and Jon Rajewski for the "
